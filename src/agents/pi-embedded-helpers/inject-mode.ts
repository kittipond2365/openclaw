...
export type InjectMode =
  | typeof INJECT_MODE.EVERY_TURN
  | typeof INJECT_MODE.ONCE
  | typeof INJECT_MODE.MINIMAL;

export const DEFAULT_INJECT_MODE = INJECT_MODE.EVERY_TURN;

export function resolveInjectMode(config?: {
  agents?: { defaults?: { workspace?: { injectMode?: InjectMode } } };
}): InjectMode {
