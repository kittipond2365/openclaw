...
In addition to caching the system prompt, OpenClaw can place up to 3 cache markers on the stable portion of conversation history. This avoids re-processing older messages on every turn, reducing costs by an estimated 20-25% for interactive sessions.
